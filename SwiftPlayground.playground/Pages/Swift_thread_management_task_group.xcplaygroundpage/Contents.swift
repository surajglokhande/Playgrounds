...
/*:
 ||------------||----------------------------------------||------------------------------------------------
 ||Feature     || Task                                   || TaskGroup
 ||------------||----------------------------------------||------------------------------------------------
 ||Purpose     || Execute a single, independent async    || Manage a dynamic collection of related
 ||            || operation                              || async operations.
 ||------------||----------------------------------------||------------------------------------------------
 ||Control     || Direct control over one task.          || Structured control over a group of tasks.
 ||------------||----------------------------------------||------------------------------------------------
 ||Child Tasks || Can create child tasks, but            || All tasks added are child tasks of the group.
 ||            || not manage a collection dynamically.   ||
 ||------------||----------------------------------------||------------------------------------------------
 ||Dynamic     || Less suitable for dynamic number of    || Ideal for dynamic number of items to process
 ||Work        || items.                                 || concurrently.
 ||------------||----------------------------------------||------------------------------------------------
 ||Awaiting    || await task.value for a single result.  || for await result in group to collect results
 ||            ||                                        || incrementally.
 ||------------||----------------------------------------||------------------------------------------------
 ||Error       || Individual try await for the task.     || Errors from any child task propagate out of the
 ||Handling    ||                                        || withTaskGroup block.
 ||------------||----------------------------------------||------------------------------------------------
 ||Cancellation|| task.cancel() on the specific task.    || Cancelling the group (or its parent) cancels
 ||            ||                                        || all child tasks
 ||--------------------------------------------------------------------------------------------------------
 */
/*:
